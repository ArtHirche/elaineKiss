...
export default function CremesBatons() {
    const categorias = [
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.breadcrumbs}><a href="/">Home</a> &gt; <a href="/produtos">Produtos</a> &gt; Cremes/Batons</div>
            ...
            <div className={styles.layout}>
                ...
                <main className={styles.main}>
                    ...
                    <section className={styles.sectionProdutos}>
                        ...
                        <h1 className={styles.sectionTitle}>Cremes/Batons</h1>
