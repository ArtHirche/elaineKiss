...
export default function PregadorDePapeisAlimentos() {
    const categorias = [
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.breadcrumbs}><a href="/">Home</a> &gt; <a href="/produtos">Produtos</a> &gt; Pregador de Papeis/Alimentos</div>
            ...
            <div className={styles.layout}>
                ...
                <main className={styles.main}>
                    ...
                    <section className={styles.sectionProdutos}>
                        ...
                        <h1 className={styles.sectionTitle}>Pregador de Papeis/Alimentos</h1>
